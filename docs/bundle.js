...
if(undefined!=='test'&&typeof window!=='undefined'&&window.XDomainRequest&&!('withCredentials'in request)&&!isURLSameOrigin(config.url)){request=new window.XDomainRequest();loadEvent='onload';xDomain=true;request.onprogress=function handleProgress(){};request.ontimeout=function handleTimeout(){};}// HTTP basic authentication
...
"use strict";
var defaults=__webpack_require__(/*! ./../defaults */ "./node_modules/axios/lib/defaults.js");var utils=__webpack_require__(/*! ./../utils */ "./node_modules/axios/lib/utils.js");var InterceptorManager=__webpack_require__(/*! ./InterceptorManager */ "./node_modules/axios/lib/core/InterceptorManager.js");var dispatchRequest=__webpack_require__(/*! ./dispatchRequest */ "./node_modules/axios/lib/core/dispatchRequest.js");/**
...
"use strict";
var utils=__webpack_require__(/*! ./../utils */ "./node_modules/axios/lib/utils.js");function InterceptorManager(){this.handlers=[];}/**
 ...
 */module.exports=function enhanceError(error,config,code,request,response){error.config=config;if(code){error.code=code;}error.request=request;error.response=response;return error;};
...
adapter=__webpack_require__(/*! ./adapters/xhr */ "./node_modules/axios/lib/adapters/xhr.js");}else if(typeof process!=='undefined'){// For node use HTTP adapter
adapter=__webpack_require__(/*! ./adapters/http */ "./node_modules/axios/lib/adapters/xhr.js");}return adapter;}var defaults={adapter:getDefaultAdapter(),transformRequest:[function transformRequest(data,headers){normalizeHeaderName(headers,'Content-Type');if(utils.isFormData(data)||utils.isArrayBuffer(data)||utils.isBuffer(data)||utils.isStream(data)||utils.isFile(data)||utils.isBlob(data)){return data;}if(utils.isArrayBufferView(data)){return data.buffer;}if(utils.isURLSearchParams(data)){setContentTypeIfUnset(headers,'application/x-www-form-urlencoded;charset=utf-8');return data.toString();}if(utils.isObject(data)){setContentTypeIfUnset(headers,'application/json;charset=utf-8');return JSON.stringify(data);}return data;}],transformResponse:[function transformResponse(data){/*eslint no-param-reassign:0*/if(typeof data==='string'){try{data=JSON.parse(data);}catch(e){/* Ignore */}}return data;}],/**
...
"use strict";
var utils=__webpack_require__(/*! ./../utils */ "./node_modules/axios/lib/utils.js");function encode(val){return encodeURIComponent(val).replace(/%40/gi,'@').replace(/%3A/gi,':').replace(/%24/g,'$').replace(/%2C/gi,',').replace(/%20/g,'+').replace(/%5B/gi,'[').replace(/%5D/gi,']');}/**
 * Build a URL by appending params to the end
 *
 * @param {string} url The base of the url (e.g., http://www.google.com)
 * @param {object} [params] The params to be appended
 * @returns {string} The formatted url
 */module.exports=function buildURL(url,params,paramsSerializer){/*eslint no-param-reassign:0*/if(!params){return url;}var serializedParams;if(paramsSerializer){serializedParams=paramsSerializer(params);}else if(utils.isURLSearchParams(params)){serializedParams=params.toString();}else{var parts=[];utils.forEach(params,function serialize(val,key){if(val===null||typeof val==='undefined'){return;}if(utils.isArray(val)){key=key+'[]';}else{val=[val];}utils.forEach(val,function parseValue(v){if(utils.isDate(v)){v=v.toISOString();}else if(utils.isObject(v)){v=JSON.stringify(v);}parts.push(encode(key)+'='+encode(v));});});serializedParams=parts.join('&');}if(serializedParams){url+=(url.indexOf('?')===-1?'?':'&')+serializedParams;}return url;};
...
"use strict";
var utils=__webpack_require__(/*! ./../utils */ "./node_modules/axios/lib/utils.js");module.exports=utils.isStandardBrowserEnv()?// Standard browser envs support document.cookie
...
"use strict";
var utils=__webpack_require__(/*! ./../utils */ "./node_modules/axios/lib/utils.js");module.exports=utils.isStandardBrowserEnv()?// Standard browser envs have full support of the APIs needed to test
...
"use strict";
var utils=__webpack_require__(/*! ../utils */ "./node_modules/axios/lib/utils.js");module.exports=function normalizeHeaderName(headers,normalizedName){utils.forEach(headers,function processHeader(value,name){if(name!==normalizedName&&name.toUpperCase()===normalizedName.toUpperCase()){headers[normalizedName]=value;delete headers[name];}});};
...
"use strict";
var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};var bind=__webpack_require__(/*! ./helpers/bind */ "./node_modules/axios/lib/helpers/bind.js");var isBuffer=__webpack_require__(/*! is-buffer */ "./node_modules/is-buffer/index.js");/*global toString:true*/// utils is a library of generic helper functions non-specific to axios
 ...
 * LICENSE file in the root directory of this source tree.
 *
 */var emptyObject={};if(undefined!=='production'){Object.freeze(emptyObject);}module.exports=emptyObject;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};var printWarning=function printWarning(){};if(undefined!=='production'){var ReactPropTypesSecret=__webpack_require__(/*! ./lib/ReactPropTypesSecret */ "./node_modules/prop-types/lib/ReactPropTypesSecret.js");var loggedTypeFailures={};printWarning=function printWarning(text){var message='Warning: '+text;if(typeof console!=='undefined'){console.error(message);}try{// --- Welcome to debugging React ---
// This error was thrown as a convenience so that you can use this stack
// to find the callsite that caused this warning to fire.
...
// same error.
loggedTypeFailures[error.message]=true;var stack=getStack?getStack():'';printWarning('Failed '+location+' type: '+error.message+(stack!=null?stack:''));}}}}}module.exports=checkPropTypes;
...
"use strict";
function checkDCE(){/* global __REACT_DEVTOOLS_GLOBAL_HOOK__ */if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__==='undefined'||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!=='function'){return;}if(undefined!=='production'){// This branch is unreachable because this function is only called
...
console.error(err);}}if(undefined==='production'){// DCE check should happen before ReactDOM bundle executes so that
// DevTools can report bad minification during injection.
checkDCE();module.exports=__webpack_require__(/*! ./cjs/react-dom.production.min.js */ "./node_modules/react-dom/cjs/react-dom.production.min.js");}else{module.exports=__webpack_require__(/*! ./cjs/react-dom.development.js */ "./node_modules/react-dom/cjs/react-dom.development.js");}
...
"use strict";
if(undefined==='production'){module.exports=__webpack_require__(/*! ./cjs/react.production.min.js */ "./node_modules/react/cjs/react.production.min.js");}else{module.exports=__webpack_require__(/*! ./cjs/react.development.js */ "./node_modules/react/cjs/react.development.js");}
...
module.exports = __webpack_require__.p + "media/favicon.ico";
...
module.exports = __webpack_require__.p + "media/github.png";
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);var _Clock=__webpack_require__(/*! ./Clock.jsx */ "./src/components/Clock.jsx");var _Clock2=_interopRequireDefault(_Clock);var _Weather=__webpack_require__(/*! ./Weather.jsx */ "./src/components/Weather.jsx");var _Weather2=_interopRequireDefault(_Weather);var _GHLink=__webpack_require__(/*! ./GHLink.jsx */ "./src/components/GHLink.jsx");var _GHLink2=_interopRequireDefault(_GHLink);var _Background=__webpack_require__(/*! ./Background.jsx */ "./src/components/Background.jsx");var _Background2=_interopRequireDefault(_Background);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var App=function(_React$Component){_inherits(App,_React$Component);function App(props){_classCallCheck(this,App);return _possibleConstructorReturn(this,(App.__proto__||Object.getPrototypeOf(App)).call(this,props));}_createClass(App,[{key:'render',value:function render(){return _react2.default.createElement('div',null,_react2.default.createElement(_Background2.default,null),_react2.default.createElement(_GHLink2.default,null),_react2.default.createElement(_Clock2.default,null),_react2.default.createElement(_Weather2.default,{refreshEvery:1800000}));}}]);return App;}(_react2.default.Component);exports.default=App;
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);var _axios=__webpack_require__(/*! axios */ "./node_modules/axios/index.js");var _axios2=_interopRequireDefault(_axios);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}/*b0e9949acd4d0ae24eae95da963d5bcca2deab2f5c8c32e34980b88c318e63f1*/var Background=function(_React$Component){_inherits(Background,_React$Component);function Background(props){_classCallCheck(this,Background);var _this=_possibleConstructorReturn(this,(Background.__proto__||Object.getPrototypeOf(Background)).call(this,props));_this.state={loaded:false,hiRes:'',loRes:''};return _this;}_createClass(Background,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;_axios2.default.get('https://api.unsplash.com/photos/random/?client_id=b0e9949acd4d0ae24eae95da963d5bcca2deab2f5c8c32e34980b88c318e63f1&featured').then(function(res){_this2.setState({hiRes:res.data.urls.full,loRes:res.data.urls.thumb});});}},{key:'imgLoaded',value:function imgLoaded(){if(this.state.hiRes!==''&&this.state.loRes!==''){this.setState({loaded:true});}}},{key:'render',value:function render(){var _state=this.state,loaded=_state.loaded,hiRes=_state.hiRes,loRes=_state.loRes;var style={backgroundImage:loaded?'url('+hiRes+')':'url('+loRes+')'};return _react2.default.createElement('div',{id:'Background',className:''},_react2.default.createElement('div',{id:'canvas',className:loaded?'loaded':'',style:style}),_react2.default.createElement('img',{className:'prefetch',hidden:true,src:hiRes,rel:'prefetch',alt:'',onLoad:this.imgLoaded.bind(this)}));}}]);return Background;}(_react2.default.Component);exports.default=Background;
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Clock=function(_React$Component){_inherits(Clock,_React$Component);function Clock(props){_classCallCheck(this,Clock);var _this=_possibleConstructorReturn(this,(Clock.__proto__||Object.getPrototypeOf(Clock)).call(this,props));_this.state={date:new Date()};return _this;}_createClass(Clock,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;setInterval(function(){return _this2.tick();},1000);}},{key:'tick',value:function tick(){var _this3=this;this.setState({date:new Date()},function(){document.title=_this3.state.date.toLocaleTimeString();});}},{key:'render',value:function render(){var date=this.state.date;var dia=['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado'];var mes=['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Setiembre','Octubre','Noviembre','Diciembre'];return _react2.default.createElement('div',{id:'Clock'},_react2.default.createElement('div',{className:'hora'},_react2.default.createElement('span',{className:'large'},date.getHours()<10?"0"+date.getHours():date.getHours(),':',date.getMinutes()<10?"0"+date.getMinutes():date.getMinutes()),_react2.default.createElement('span',{className:'small'},date.getSeconds()<10?'0'+date.getSeconds():date.getSeconds())),_react2.default.createElement('div',{className:'fecha'},dia[date.getDay()],' ',date.getDate(),' de ',mes[date.getMonth()]));}}]);return Clock;}(_react2.default.Component);exports.default=Clock;

/***/ }),

/***/ "./src/components/GHLink.jsx":
/*!***********************************!*\
  !*** ./src/components/GHLink.jsx ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);var _github=__webpack_require__(/*! ../assets/images/github.png */ "./src/assets/images/github.png");var _github2=_interopRequireDefault(_github);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var GHLink=function(_React$Component){_inherits(GHLink,_React$Component);function GHLink(props){_classCallCheck(this,GHLink);return _possibleConstructorReturn(this,(GHLink.__proto__||Object.getPrototypeOf(GHLink)).call(this,props));}_createClass(GHLink,[{key:'render',value:function render(){return _react2.default.createElement('div',{id:'Ghlink',className:'fixed top-right'},_react2.default.createElement('a',{href:'https://github.com/MMachado-uy/react-demo',target:'_blank'},_react2.default.createElement('img',{src:_github2.default,alt:'Github Logo'})));}}]);return GHLink;}(_react2.default.Component);exports.default=GHLink;
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Loader=function(_React$Component){_inherits(Loader,_React$Component);function Loader(props){_classCallCheck(this,Loader);return _possibleConstructorReturn(this,(Loader.__proto__||Object.getPrototypeOf(Loader)).call(this,props));}_createClass(Loader,[{key:"render",value:function render(){return _react2.default.createElement("div",{className:"loader"},_react2.default.createElement("div",{className:"bouncer-1"}),_react2.default.createElement("div",{className:"bouncer-2"}));}}]);return Loader;}(_react2.default.Component);exports.default=Loader;
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);var _axios=__webpack_require__(/*! axios */ "./node_modules/axios/index.js");var _axios2=_interopRequireDefault(_axios);var _Loader=__webpack_require__(/*! ./Loader.jsx */ "./src/components/Loader.jsx");var _Loader2=_interopRequireDefault(_Loader);var _utils=__webpack_require__(/*! ../utils/utils */ "./src/utils/utils.js");var Utils=_interopRequireWildcard(_utils);function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj;}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key];}}newObj.default=obj;return newObj;}}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Weather=function(_React$Component){_inherits(Weather,_React$Component);function Weather(props){_classCallCheck(this,Weather);var _this=_possibleConstructorReturn(this,(Weather.__proto__||Object.getPrototypeOf(Weather)).call(this,props));_this.state={lat:'',lon:'',weatherDesc:{},weatherData:{},weatherLoaded:false,clouds:{},wind:{},city:'',country:'',refreshEvery:_this.props.refreshEvery};return _this;}_createClass(Weather,[{key:'componentWillMount',value:function componentWillMount(){this.getClientLocationAndWeather();}},{key:'componentDidMount',value:function componentDidMount(){var _this2=this;var refreshEvery=this.state.refreshEvery;setInterval(function(){return _this2.getCurrentWeather();},refreshEvery);}},{key:'getClientLocationAndWeather',value:function getClientLocationAndWeather(){var _this3=this;if('geolocation'in navigator){navigator.geolocation.getCurrentPosition(function(location){_this3.setState({lat:location.coords.latitude,lon:location.coords.longitude},function(){_this3.getCurrentWeather();});},function(reject){_this3.getLocation();});}}},{key:'getLocation',value:function getLocation(){var _this4=this;_axios2.default.get('//api.ipify.org').then(function(res){if(res.status>=200&&res.status<300){_axios2.default.get('https://ipapi.co/'+res.data+'/json/').then(function(res){if(res.status>=200&&res.status<300){var _res$data=res.data,latitude=_res$data.latitude,longitude=_res$data.longitude,city=_res$data.city,country_name=_res$data.country_name;_this4.setState({lat:latitude,lon:longitude,city:city,country:country_name},function(res){_this4.getCurrentWeather();});}}).catch(function(error){console.log('Error calling the geolocation API');});}else{console.log('Error calling the weather API');}}).catch(function(error){console.log('Error calling the weather API');});}},{key:'getCurrentWeather',value:function getCurrentWeather(){var _this5=this;var _state=this.state,lat=_state.lat,lon=_state.lon;_axios2.default.get('//api.openweathermap.org/data/2.5/weather?lat='+lat+'&lon='+lon+'&APPID=f560f5686c9d44522da78432786fa3f6').then(function(res){var _res$data2=res.data,clouds=_res$data2.clouds,wind=_res$data2.wind;var _state2=_this5.state,city=_state2.city,country=_state2.country;if(city===''||country===''){city=res.data.name;country=Utils.mapCountryName(res.data.sys.country);}var weatherDesc=res.data.weather[0];var weatherData=res.data.main;_this5.setState({weatherDesc:weatherDesc,weatherData:weatherData,weatherLoaded:true,clouds:clouds,wind:wind,city:city,country:country});});}},{key:'render',value:function render(){var _state3=this.state,weatherDesc=_state3.weatherDesc,weatherData=_state3.weatherData,weatherLoaded=_state3.weatherLoaded,clouds=_state3.clouds,wind=_state3.wind,city=_state3.city,country=_state3.country;var iconClass=Utils.mapWeatherIcon(weatherDesc.icon);var currTemp=Utils.kelvinToCelsius(weatherData.temp);var windDirection='wi wi-wind from-'+wind.deg+'-deg';return!weatherLoaded?_react2.default.createElement('div',{id:'Weather'},_react2.default.createElement(_Loader2.default,null)):_react2.default.createElement('div',{id:'Weather',className:'text-center'},_react2.default.createElement('span',{className:iconClass}),_react2.default.createElement('span',null,currTemp,'\xB0 |',weatherData.pressure,' hPa |',wind.speed,' m/s',_react2.default.createElement('span',{className:windDirection})),_react2.default.createElement('div',null,_react2.default.createElement('span',null,city,', ',country)));}}]);return Weather;}(_react2.default.Component);exports.default=Weather;
...
"use strict";
var _react=__webpack_require__(/*! react */ "./node_modules/react/index.js");var _react2=_interopRequireDefault(_react);var _reactDom=__webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");var _reactDom2=_interopRequireDefault(_reactDom);var _App=__webpack_require__(/*! ./components/App.jsx */ "./src/components/App.jsx");var _App2=_interopRequireDefault(_App);__webpack_require__(/*! ./assets/styles/main.scss */ "./src/assets/styles/main.scss");__webpack_require__(/*! ./assets/images/favicon.ico */ "./src/assets/images/favicon.ico");function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_reactDom2.default.render(_react2.default.createElement(_App2.default,null),document.getElementById('App'));
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports.kelvinToCelsius=kelvinToCelsius;exports.kelvinToFahrenheit=kelvinToFahrenheit;exports.msToMph=msToMph;exports.msToKnots=msToKnots;exports.msToFts=msToFts;exports.msToKmh=msToKmh;exports.capitalize=capitalize;exports.capitalizePhrase=capitalizePhrase;exports.mapWeatherIcon=mapWeatherIcon;exports.mapCountryName=mapCountryName;/**********************//*   Unit conversion   /
/**********************/function kelvinToCelsius(k){return Math.round(k-273.15);}function kelvinToFahrenheit(k){return Math.round(k*9/5-459.67);}function msToMph(ms){return Math.round(ms*2.23694);}function msToKnots(ms){return Math.round(ms*1.94254);}function msToFts(ms){return Math.round(ms*3.28084);}function msToKmh(ms){return Math.round(ms*3.6);}/**********************//*   Data conversion   /
/**********************//**
 * Capitalizes the first letter of a given string
 * Ignoring some character symbols i.e: (hello) -> (Hello)
 * @param {String} word
 */function capitalize(word){var uppercaseReset=['{','[','!','(','¿','-','<','¡'];var result=word;if(word){var i=0;while(uppercaseReset.indexOf(word.charAt(i))>=0&&i<word.length){i++;}if(i>0){result=word.slice(0,i).toLowerCase()+word.charAt(i).toUpperCase()+word.slice(i+1).toLowerCase();}else{result=word.charAt(i).toUpperCase()+word.slice(i+1).toLowerCase();}}return result;}/**
 * Capitalizes each first letter in a phrase and low-cases the rest of the word
 * @param {String} phrase 
 */function capitalizePhrase(phrase){var result=phrase;if(phrase){var words=result.split(' ');words=words.map(function(word){return capitalize(word);});result=words.join(' ');}return result;}/**
